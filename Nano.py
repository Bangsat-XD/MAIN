...
def moch_yayan():
    ...
    print ' [%s3%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Total Followers'%(O,N);time.sleep(0.03)
    print ' [%s4%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Like Postingan'%(O,N);time.sleep(0.03)
    print ' [%s5%s]\x1b[1;96m◍➤\x1b[1;97m \x1b[1;92mMulai Crack\x1b[1;97m'%(O,N);time.sleep(0.03)
    print ' [%s6%s]\x1b[1;96m◍➤\x1b[1;97m Check Informasi Akun Fb'%(O,N);time.sleep(0.03)
    print ' [%s7%s]\x1b[1;96m◍➤\x1b[1;97m Lihat Hasil Crack'%(O,N);time.sleep(0.03)
